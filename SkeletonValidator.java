...
public class SkeletonValidator {
	...
	public SkeletonValidator() {
		...
		validateClassName("BookingManagementSystem");
		validateClassName("Booking");
		validateClassName("DB");
		validateMethodSignature(
				"viewBookings:java.util.Map","BookingManagementSystem");
		validateMethodSignature(
				"getConnection:java.sql.Connection","DB");
